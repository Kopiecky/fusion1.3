    ...
    def listener_callback(self, msg):
        ...
        if(flag==1):
            if(tright_motor_direction==1 and tleft_motor_direction==1):
                ...
                right_motor_pwm=lmd_pwm_r+lmd_pwm_r/2
                left_motor_pwm=lmd_pwm_r-lmd_pwm_r/2
                ...
                right_motor_pwm=lmd_pwm_r-lmd_pwm_l/2
                left_motor_pwm=lmd_pwm_l+lmd_pwm_l/2
                right_motor_direction=lmd_dir_r
                left_motor_direction=lmd_dir_l
                flag=1
                ...
                if(tleft_motor_pwm!=lmd_pwm_r):
                    lmd_pwm_l=lmd_pwm_r=tleft_motor_pwm
                right_motor_pwm=lmd_pwm_r+lmd_pwm_l/2
                left_motor_pwm=lmd_pwm_r-lmd_pwm_l/2
                right_motor_direction=lmd_dir_r
                left_motor_direction=lmd_dir_l
                flag=1
                ...
                right_motor_pwm=lmd_pwm_r-lmd_pwm_r/2
                left_motor_pwm=lmd_pwm_l+lmd_pwm_r/2
